...
public class Absen {
    ...
    public boolean equals(Object o) {
        ...
        if (getPegawai() != null ? !getPegawai().equals(absen.getPegawai()) : absen.getPegawai() != null) return false;
        if (getDatang() != null ? !getDatang().equals(absen.getDatang()) : absen.getDatang() != null) return false;

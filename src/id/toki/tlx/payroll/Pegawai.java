...
public class Pegawai {
    ...
    public Pegawai(String nomer, String nama, BigDecimal gaji, BigDecimal denda, BigDecimal lembur, BigDecimal transport) {
        this.nomer = nomer;
        this.nama = nama;
        this.gaji = gaji;
        this.denda = denda;
    ...
    public boolean equals(Object o) {
        ...
        if (getNomer() != null ? !getNomer().equals(pegawai.getNomer()) : pegawai.getNomer() != null) return false;
        if (getNama() != null ? !getNama().equals(pegawai.getNama()) : pegawai.getNama() != null) return false;
        if (getGaji() != null ? !getGaji().equals(pegawai.getGaji()) : pegawai.getGaji() != null) return false;
        if (getDenda() != null ? !getDenda().equals(pegawai.getDenda()) : pegawai.getDenda() != null) return false;
        if (getLembur() != null ? !getLembur().equals(pegawai.getLembur()) : pegawai.getLembur() != null) return false;
        return getTransport() != null ? getTransport().equals(pegawai.getTransport()) : pegawai.getTransport() == null;
    }

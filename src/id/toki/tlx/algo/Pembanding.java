...
public class Pembanding {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Memberikan hasil true jika nilai a lebih dari sama dengan nilai b = " + (c >= d));
        System.out.println("Memberikan hasil true jika nilai a kurang dari sama dengan nilai b = " + (c <= d));
    }
}

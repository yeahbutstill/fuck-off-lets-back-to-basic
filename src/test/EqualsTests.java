...
public class EqualsTests {
    ...
    public void testEqualsProduct() {
        ...
        /*
         ...
         Jika nilai yang dikembalikan lebih dari nol, maka String yang kedua (yang dikirimkan ke parameter pada method compareTo() ) memiliki posisi kamus lebih dulu
         */

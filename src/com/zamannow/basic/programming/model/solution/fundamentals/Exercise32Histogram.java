...
public class Exercise32Histogram {
  ...
  public static void main(String[] args) {
    ...
    try {
      while (args[numberIndex] != null) {
        numbers.add(
            Double.parseDouble(args[numberIndex])); // {2, 2.5, 4.3, 5.5, 6.6, 6.7, 6.8, 8.3, 10};
        numberIndex++;
      }
  ...
  private static void histogram(
      int numberOfIntervals, double left, double right, double[] numbers) {
  ...
  private static void computeHistogramValues(
      int n, double l, double r, double[] numbers, int[] numbersInInterval) {
    double interval = r - l;

...
/**
 * R-1.1 Tulis metode Java singkat, inputAllBaseTypes, yang memasukkan nilai yang berbeda dari
 * setiap tipe dasar dari input standar perangkat dan mencetaknya kembali ke perangkat output
 * standar.
 */
public class Main {

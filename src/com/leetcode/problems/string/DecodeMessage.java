...
public class DecodeMessage {
    public static void main(String[] args) {
        ...
        String s = new Solution2325().decodeMessage(key, message);
...
class Solution2325 {
    public String decodeMessage(String key, String message) {
        ...
        // After the first pass all the letters of the key will be mapped with their respective original
        // letters.
        for (int i = 0; i < message.length(); i++) {
            if (letters.containsKey(message.charAt(i))) {
                ...
                // They will not be replaced by any letters hence original letter is appended into the
                // StringBuilder
            }
        }
        return ans.toString();

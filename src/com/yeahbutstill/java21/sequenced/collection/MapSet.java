...
public class MapSet {
    public static void main(String[] args) {
        /**
         * yang membedakan dari SequencedSet adalah tidak bisa addFirst dan addLast jika dipaksakan akan
         * error "UnsupportedOperationException" untuk Set memang tidak ada opration addFirst dan
         * addLast karena percuma juga kalau kita masukan di akhir atau di awal, dia akan tetap
         * diurutkan automatic
         */

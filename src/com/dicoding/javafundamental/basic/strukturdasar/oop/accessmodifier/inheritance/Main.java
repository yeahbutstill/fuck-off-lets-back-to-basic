...
public class Main {
    public static void main(String[] args) {
         ...
         * Tapi seekor hewan belum tentu kucing dan pastinya hewan adalah instans dari kelas Hewan
        ...
        /**
         * Perlu dilakukan casting untuk mengubah instance hewan menjadi instance kucing.
         * Casting sendiri adalah mengubah suatu tipe data menjadi tipe data yang lain.
         * Pada inheritance sendiri, casting dapat dilakukan terhadap kelas yang mempunyai hubungan parent-child.
         * Analoginya kucing adalah pasti hewan tetapi belum tentu hewan adalah kucing.
         * Bisa jadi harimau atau elang atau yang lainnya. bukan?
         * Sehingga jika casting gagal akan muncul sebagai ClassCastException.
         */

...
public class CalculateComplicatedDateJodaTest {
  public static void main(String[] args) {
     ...
     * dibuat implementasinya menggunakan library JDK, tetapi menggunakan Joda Time perhitungan ini
     * sangat sederhana dan hanya memerlukan beberapa baris kode saja. Implementasinya :
     */
    DateTime d = new DateTime(2000, 1,1,0,0,0,0);
    System.out.println("date: " + d.plusMonths(1)
            .plusDays(45)

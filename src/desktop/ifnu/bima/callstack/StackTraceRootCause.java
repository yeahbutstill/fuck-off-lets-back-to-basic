...
/**
 * Call Stack adalah urutan pemanggilan method di dalam aplikasi java. Awal dari pemanggilan method
 * tentu saja adalah method main, kemudian di dalam method main tersebut pasti ada kode untuk
 * memanggil method lain dalam suatu class, kemudian method tersebut memanggil lagi method yang lain
 * dan seterusnya sehingga proses pemanggilan methodnya bertumpuktumpuk. Nah tumpukan pemanggilan
 * method ini yang kita sebut dengan call stack.
 *
 * <p>Bayangkan call stack itu layaknya sebuah gedung bertingkat, fondasi gedung bertingkat tersebut
 ...
 * dari sebuah exception sangat penting dalam proses memperbaiki aplikasi, selama root cause belum
 * ditemukan, biasanya kita hanya bisa menebak-nebak apa yang terjadi dengan aplikasi tetapi tidak
 * bisa memastikan bagian mana yang bermasalah. Stack trace dengan gamblang akan menunjukkan root
 * cause terjadinya exception, penting sekali untuk melakukan log terhadap stack trace ini agar
 * mempercepat pencarian kesalahan dalam aplikasi.
 */
public class StackTraceRootCause {
    ...
    /**
     * Ada pepatah kuno developer bilang: “kemampuan developer junior dan senior dalam menulis program
     * tidak akan jauh berbeda karena dibatasi kemampuan manusia mengetik yang terbatas, tetapi
     * kemampuan junior developer dan senior dalam menganalisa kesalahan plus mencari solusi kesalahan
     * itu bisa berbeda hingga puluhan ribu kali. Junior developer bisa berhari hari tidak bisa
     * menemukan kesalahan dan solusinya, sedangkan senior developer bisa hanya dengan sekali lihat
     * langsung tahu dimana salahnya dan bagaimana mengatasi kesalahan tersebut”.
     */
}
